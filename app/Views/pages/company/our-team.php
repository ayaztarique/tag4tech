        <div id="content" class="site-content">
            ...
            <section class="team-top space-sm-top">
                ...
                <div class="container-fluid text-center">
                    <img src="https://via.placeholder.com/1678x640.png" alt="">
                </div>
            </section>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="img-Engitech">
                                <img src="https://via.placeholder.com/1251x268.png" alt="" class="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 no-padding">
                            <div class="team-wrap v3">
                                <div class="team-thumb">
                                    <img src="https://via.placeholder.com/720x987.png" alt="">                                 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 align-self-end">
                                <div class="ot-button text-center text-md-right">
                                    <a href="<?php echo base_url() ?>/contact" class="octf-btn octf-btn-primary">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
