                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <table class="shop_table woocommerce-checkout-review-order-table">
                                ...
                                <tbody>
                                    <tr class="cart_item">
                                        <td class="product-name">Hoodie with Logo <strong class="product-quantity">× 1</strong></td>
                                        <td class="product-total"><span class="amount"><span>$</span>39.99</span></td>
                                    </tr>
                                    <tr class="cart_item">
                                        <td class="product-name">Dark T-Shirt with Logo <strong class="product-quantity">× 1</strong></td>
                                        <td class="product-total"><span class="amount"><span>$</span>59.99</span></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr class="cart-subtotal">
                                        <th>Subtotal</th>
                                        <td><span class="amount"><span>$</span>99.98</span></td>
                                    </tr>
                                    <tr class="order-total">
                                        <th>Total</th>
                                        <td><strong><span class="amount"><span>$</span>99.98</span></strong> </td>
                                    </tr>
                                </tfoot>
                            </table>
