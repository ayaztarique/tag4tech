<div id="content" class="site-content">
            <div class="page-header flex-middle">
                <div class="container">
                    <div class="inner flex-middle">
                        <h1 class="page-title">Portfolio Single</h1>
            ...
            <section class="portfolio-single">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <img src="https://via.placeholder.com/1170x700.png" alt="" class="single-project-img">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <h3>How it Works </h3>
                            <p><span class="drop-cap"><span class="drop-cap-letter">M</span></span> obile apps have already penetrated every sphere of our lives and every imaginable business niche. Naturally, the appeal of mobile apps for its market potential cannot fade away anytime soon, at least until another great technology can replace mobile apps. development company and its business clients. So, what about the failure of other apps? What are the key factors responsible for the failure of millions of apps? Well, apart from the ill-conceived app idea and development and design flaws many apps simply fail because of their <strong>pre-launch and post-launch shortcomings.</strong></p>
                            <p>Front-end development essentially focuses and works on the visual perceptions of a website. It’s about the look, load time, pattern and functionality of the components of a website. Front-End is a mix of programming and layout that powers the visuals and interactions on the web. The talented Front-end developers provide turnkey Front-End development services whether you are planning to change the Front-End from older technology to newer one, for example Angular.</p>
                            <blockquote>
                                <p>I cannot give you the formula for success, but I can give you the formula for failure. <br> It is: Try to please everybody.<br>
                                <cite>– Herbert Bayard Swope</cite></p>
                            </blockquote>
                            <div class="simple-slider owl-theme owl-carousel">
                                <div class="projects-slide-item">
                                    <img src="https://via.placeholder.com/574x325.png" alt="">
                                </div>
                                <div class="projects-slide-item">
                                    <img src="https://via.placeholder.com/574x325.png" alt="">
                                </div>
                                ...
                                <div class="entry-footer clearfix">
                                    ...
                                    <span class="sl-wrapper">
                                        <a href="#" class="sl-button sl-button-1263" title="Like">
                                            <span class="sl-icon"><i class="far fa-heart"></i></span>
                                            <span class="sl-count">125</span>
                                        </a>
                                    </span>
                                </div>
                            </div>
                            <div id="comments" class="comments-area project-comtmnents">
                                <h2 class="comments-title">Comments <span>(02)</span></h2>
                                        ...
                                        <article class="comment-wrap clearfix">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <div class="comment-text">
                                                    <p>Engitech is always changing so leaving the strategy and tactics to Onum has more than paid for itself.  We estimate ROI is over 10 to 1 – I can’t say enough about this team.</p>
                                                </div>
                                            </div>
                                        </article>
                                    </li>
                                    ...
                                    <li class="comment odd alt comment-item">
                                        <article class="comment-wrap clearfix">
                                            ...
                                            <div class="comment-content">
                                                ...
                                                <div class="comment-text">
                                                    <p>Engitech  has been extremely consistent and reliable through our entire engagement. Our results speak for themselves.</p>
                                                </div>
                                            </div>
                                        </article>
                                    </li>
                            ...
                            <form action="teamcontact.php" method="post" class="wpcf7-form init">
                                <div class="member-form comment-respond">
                                    ...
                                    <div class="row">
                                        ...
                                        <p class="col-md-6">
                                            <input type="email" name="email" value="" size="40" placeholder="Your Email *" required>
                                        </p>
                                    </div>
                                    <p>
                                        <input type="text" name="site" value="" size="40" placeholder="Website">
                                    </p>
                                    <p>
