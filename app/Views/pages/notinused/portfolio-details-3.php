            ...
            <div class="page-header flex-middle">
                <div class="container">
                    <div class="inner flex-middle">
                        <h1 class="page-title">Portfolio Single 3</h1>
                        <ul id="breadcrumbs" class="breadcrumbs none-style">
                            <li><a href="index.html">Home</a></li>
                            <li class="active">Portfolio Single 3</li>
                        </ul>    
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-5">
                            <div class="gallery-thumbnail mb30">
                                <a href="https://via.placeholder.com/1170x700.png" class="image-link"> 
                                    <img src="https://via.placeholder.com/1170x700.png" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6 mb-5">
