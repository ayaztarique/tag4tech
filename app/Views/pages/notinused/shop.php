                        ...
                        <div class="widget-area primary-sidebar col-lg-3 col-md-12 col-sm-12">
                            ...
                            <aside class="widget widget_products">
                                ...
                                <ul class="popular-product clearfix">
                                    <li class="clearfix"> 
                                        <div class="thumb">
                                            <a href="single-product.html"><img src="https://via.placeholder.com/70x70.png" alt=""></a>
                                        </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="product-item">
                                            <div class="product-media"> 
                                                <a href="single-product.html">
                                                    <img src="https://via.placeholder.com/300x300.png" class="" alt="">
                                                </a>
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">T-Shirt with Logo</a></h2>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Accessories for Watch</a></h2>
                                            <div class="star-rating">
                                                <span><i class="fa fa-star"></i></span>
                                                <span><i class="fa fa-star"></i></span>
                                                <span><i class="fa fa-star"></i></span>
                                    ...
                                    <div class="col-md-4 col-sm-6 last">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Hoodie with Logo</a></h2>
                                            <div class="star-rating">
                                                <span><i class="fa fa-star"></i></span>
                                                <span><i class="fa fa-star"></i></span>
                                                <span><i class="fa fa-star"></i></span>
                                    ...
                                    <div class="col-md-4 col-sm-6 first">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Your Energy Drink</a></h2>
                                            <span class="price-product"><span class="amount"><span>$</span>39.99</span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="col-md-4 col-sm-6 last">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Case for IPhone 11 Pro</a></h2>
                                            <span class="price-product">
                                                <del><span class="amount"><span>$</span>59.99</span></del> 
                                                <ins><span class="amount"><span>$</span>29.99</span></ins>
                                            </span>
                                    ...
                                    <div class="col-md-4 col-sm-6 first">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Dark Bag with Logo</a></h2>
                                            <span class="price-product">
                                    ...
                                    <div class="col-md-4 col-sm-6 last">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Note with Logo</a></h2>
                                    ...
                                    <div class="col-md-4 col-sm-6 first">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Skateboard with Logo</a></h2>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Natural Coffee</a></h2>
                                    ...
                                    <div class="col-md-4 col-sm-6 last">
                                        <div class="product-item">
                                            ...
                                            <h2 class="woocommerce-loop-product__title"><a href="single=product.html">Blue T-Shirt with Logo</a></h2>
                                            <span class="price-product"><span class="amount"><span class="">$</span>59.99</span></span>
                                        </div>
                                    </div>
                                </div>
